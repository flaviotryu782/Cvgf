...
public class PlayerController : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (pass) ballController.Pass(GetPassDirection(), passPower);
        else if (kick) ballController.Shoot((enemyGoal.position - ball.position).normalized, shotPower, type, charge);
    }
